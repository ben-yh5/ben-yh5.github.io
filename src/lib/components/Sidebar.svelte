<script lang="ts">
	...
	let { activeSection = 'projects' }: Props = $props();
</script>
...
<aside class="sidebar">
	<div class="sidebar-top">
		...
		<nav>
			...
			<a href="https://github.com/ben-6" target="_blank" rel="noopener noreferrer">GitHub<svg class="external-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="11" height="11" fill="currentColor"><path d="M3.75 2h3.5a.75.75 0 0 1 0 1.5H4.5v8h8V8.75a.75.75 0 0 1 1.5 0v3.5A1.75 1.75 0 0 1 12.25 14h-8.5A1.75 1.75 0 0 1 2 12.25v-8.5C2 2.784 2.784 2 3.75 2Zm6.5 0h2a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0V3.56L7.78 7.28a.75.75 0 0 1-1.06-1.06l3.72-3.72H9.25a.75.75 0 0 1 0-1.5Z"/></svg></a>
		</nav>
	</div>
	<div class="sidebar-bottom">
		<a href="mailto:bhu05@">bhu05@uw.edu</a>
		<div class="coord">[47.6538, -122.3078]</div>
	</div>
</aside>
